<div class="container"> 
    <div class="box-container group">
        <h2 style="font-size:180%;font-weight:bold;color:#111;text-align:center;margin-bottom:6px;padding-top:20px;">
            SHOWROOM MG PHÚ THỌ</h2>

        <p style="font-size:120%;text-align:center;margin-bottom:20px;">CHÚNG TÔI LUÔN GIỮ VỮNG NHỮNG CAM KẾT VỚI QUÝ KHÁCH
            HÀNG</p>
