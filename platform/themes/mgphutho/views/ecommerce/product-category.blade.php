...
<div class="container">
    ...
    <div id="gridproductlist">
        ...
        <div
            ...
            <h3 style="font-size: 120%;font-weight:bold;margin-bottom:10px;">MG PHÚ THỌ&nbsp;ƯU ĐÃI LỚN TRONG THÁNG</h3>

            <h4 style="font-size: 120%;font-weight:bold;margin-bottom:10px;">HỖ TRỢ TRẢ GÓP VAY 90% - LÃI SUẤT ƯU ĐÃI
            </h4>

            <div class="row">
                <div class="col-12 col-md-6" style="margin-top:8px; padding-left: 8px; padding-right: 8px;"><a href="tel:{{theme_option('hotline')}}"
                ...
                <div class="col-12 col-md-6" style="margin-top:8px; padding-left: 8px; padding-right: 8px;"><a
                        href="javascript:openModelBaoGia();"
                        style="display: block;overflow: hidden;padding: 11px 0;border-radius: 4px;font-size: 120%;line-height: normal;text-align: center;margin-top:.5rem;color: #fff!important;background-color:#288ad6!important;text-decoration:none!important;"><strong>NHẬN
